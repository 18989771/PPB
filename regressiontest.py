...
ada_sklearn = AdaBoostRegressor(n_estimators=100, random_state=42)
ada_sklearn.fit(X_train, y_train)
pred_sklearn = ada_sklearn.predict(X_test)

rmse_sklearn = mean_squared_error(y_test, pred_sklearn, squared=False)
r2_sklearn = r2_score(y_test, pred_sklearn)

print(f"sklearn AdaBoost RMSE: {rmse_sklearn:.4f}, R2: {r2_sklearn:.4f}")